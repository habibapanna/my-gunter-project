    ...
    <div className="bg-black min-h-screen pt-10 text-white">
      ...
      <section className="bg-black px-5 md:px-20 mt-10">
        ...
        <div className="text-center mt-8">
          <button className="relative bg-orange-600 px-2 py-2 lg:px-6 lg:py-4 text-white font-semibold transition-all duration-300 shadow-animation text-[16px] lg:text-[18px] cursor-pointer">
