      ...
      <section className="bg-purple-600 px-5 md:px-20 mt-10">
        ...
        <ul className="space-y-3">
          {services.map((service, index) => (
            <li key={index} className="flex items-center text-gray-200 text-[16px]">
        ...
        <div className="text-center mt-8">
          <button className="relative bg-amber-500 px-2 py-2 lg:px-6 lg:py-4 text-white font-semibold transition-all duration-300 shadow-animation text-[16px] lg:text-[18px] cursor-pointer">
