  ...
  return (
    <div className="bg-purple-600 min-h-screen pt-10 text-white">
      ...
      <section className="px-5">
        ...
        <p className="text-gray-200 font-normal text-[16px] max-w-3xl mx-auto">
      ...
      <section className="services bg-purple-600 px-5 md:px-20 mt-10">
        ...
        <div className="space-y-2">
          {accordions.map((accordion, index) => (
            <div key={index} className="border border-purple-500 overflow-hidden ">
              <button
                className="w-full flex gap-1 lg:gap-5 items-center bg-purple-500 text-white text-[16px]"
                onClick={() => toggleAccordion(index)}
              >
                <span className="p-1 lg:p-3 bg-amber-500 text-white font-normal">
        ...
        <div className="text-center mt-5">
          <button className="relative bg-amber-500 px-2 py-2 lg:px-6 lg:py-4 text-white lg:font-semibold flex items-center gap-2 overflow-hidden transition-all duration-300 shadow-animation text-sm lg:text-[18px] cursor-pointer">
