...
const Main = () => {
    ...
    return (
        <div className="relative min-h-screen max-w-7xl mx-auto flex flex-col">
            ...
            <div 
                onClick={scrollToTop} 
                className="fixed bottom-2 right-6 w-12 h-12 flex items-center justify-center rounded-full bg-purple-600 hover:bg-amber-500 text-white cursor-pointer shadow-lg transition-all z-50"
            >
...
// {theme === "light" && (
//   <div className="fixed bottom-2 right-6 z-50 group">
//     {/* Chat Box */}
