...
const OurServices = () => {
    return (
        <div>
            ...
            <div className='mt-10'>
                {/* "All Services" Button */}
                <button className="shadow-animation bg-purple-600 px-4 py-2 lg:px-6 lg:py-4 text-white font-semibold flex items-center gap-2 overflow-hidden shadow-animation mx-auto cursor-pointer">
