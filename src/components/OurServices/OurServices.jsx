            ...
            <div className='bg-black p-10'>
                <div className='flex justify-between items-center'>
                    <div>
                        ...
                        <h2 className='text-4xl font-bold mt-3 text-white'>Our Services</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-10 bg-black">
                {services.map((service, index) => (
                    ...
                    >
                        ...
                        {/* Left Icon */}
                        <div className="text-2xl text-orange-600 p-4 bg-black group-hover:bg-white rounded-full transition-all duration-500  z-10">
                            {service.icon}
                        </div>
