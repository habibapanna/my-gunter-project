...
const CalendlyModal = () => {
  ...
  return (
    <div>
      <button
        onClick={toggleModal}
        className="text-white bg-purple-600 shadow-animation text-xs md:text-sm px-4 md:px-8 py-2 md:py-3 rounded-full font-semibold transition duration-300 cursor-pointer flex items-center gap-2"
      >
        BOOK A CALL
      </button>
