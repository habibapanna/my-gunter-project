...
import lottie from "../assets/service/blog.json"; // Update with correct path
...
const Blog = () => {
    ...
    // Services List
    const blogs = [
        { title: "The Ultimate Guide to Starting and Scaling an eCommerce Business in 2025", path: "/blog/blog-1" },
        { title: "The Ultimate Guide to Amazon and Walmart Arbitrage in 2025", path: "/blog/blog-2" },
        { title: "The Benefits of Private Label and Branding in eCommerce", path: "/blog/blog-3" },
    ];
        ...
        <div className="bg-white">
            ...
            <div className="bg-black py-20">
                <h1 className="text-4xl font-bold mb-5 text-center text-white">
                    {currentBlog ? currentBlog.title : "Blog"}
                </h1>
                ...
                <div className="col-span-4 bg-white p-4">
                  ...
                  <div className="border-1 border-gray-300 w-80 mx-auto">
                      ...
                      <div className="flex flex-col ">
                        {blogs.filter(blog => blog.title.toLowerCase().includes(search.toLowerCase())).map((blog, index) => (
                            <button
                                key={index}
                                className={`flex justify-between items-center p-3 border-gray-300 transition-all duration-300 relative transform text-left 
                                ${location.pathname === blog.path ? "bg-orange-600 text-white" : "bg-white text-black hover:text-orange-600 hover:scale-95"}`}
