                    ...
                    <div className="bg-black w-full max-w-sm shrink-0 shadow-2xl p-6">
                        <form onSubmit={handleEmailLogin}>
                            <fieldset className="fieldset">
                                ...
                                <button
                                    type="submit"
                                    className="w-full bg-orange-600 px-6 py-3 text-white font-semibold transition duration-300 shadow-animation mt-3 cursor-pointer"
                                >
                                    Sign In
                                </button>
                            </fieldset>
                        ...
                        <button
                            ...
                            className="w-full px-6 py-3 text-white font-semibold transition duration-300 shadow-animation mt-3 border border-orange-600 flex items-center gap-5 justify-center hover:border-gray-400 hover:text-orange-600 cursor-pointer"
                        >
