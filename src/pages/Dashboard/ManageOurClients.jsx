...
const ManageOurClients = () => {
  ...
  const handleEdit = async (id, currentImageUrl) => {
    ...
    if (imageUrl) {
      try {
        await axios.put(`https://my-gunter-project-server.vercel.app/clients/${id}`, { imageUrl });
  ...
  return (
    <div className="p-4 overflow-x-auto">
      <h2 className="text-xl lg:text-2xl font-bold mb-4 text-purple-600 text-center">Manage Retails</h2>
